...
export function BlogCard({
  ...
  return (
    <a
      href={href}
      className="p-8 bg-white rounded-3xl shadow-md outline outline-1 outline-offset-[-1px] outline-gray-200 flex flex-col justify-start items-start overflow-hidden hover:shadow-lg transition-shadow group"
    >
      <div className="w-full h-56 relative border-b border-gray-200 flex flex-col justify-center items-start overflow-hidden rounded-t-xl mb-8">
        <img
          className="w-full h-full object-cover relative group-hover:scale-105 transition-transform duration-500"
          src={image}
          alt={title}
          width={936}
          height={527}
